...
class ServiceRichPresence:
    ...
    def setResumedState(self, state):
        self.resumed = state
    ...
    def craftNoVideoState(self, data):
        if self.settings['inmenu']:
            activity = {'assets' : {'large_image' : 'kodi',
    ...
    def updatePresence(self):
        if self.connected:
            ...
            if self.resumed:
                    activity['assets']['small_image'] = 'resume'
